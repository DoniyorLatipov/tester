...
<head>
	...
	<title>О нас – Acarkan & Semenov | Международная юридическая компания</title>
	<meta name="description"
		content="Acarkan & Semenov – международная юридическая фирма с лицензиями в США, Турции, Англии и Ирландии. Корпоративное право, налоги, иммиграция, недвижимость, уголовные и семейные дела.">
	<meta name="keywords"
		content="международные адвокаты, юристы США, корпоративное право, налоговые споры, иммиграция в США, недвижимость, уголовные дела, семейные споры, юридическая помощь СНГ, бизнес в США">

	<!-- Canonical URL -->
	<link rel="canonical" href="https://acarkansemenov.com/about">

	<!-- Open Graph (для соцсетей) -->
	<meta property="og:locale" content="ru_RU">
	<meta property="og:type" content="website">
	<meta property="og:title" content="О нас – Acarkan & Semenov">
	<meta property="og:description"
		content="Международная юридическая фирма с лицензиями в США, Турции, Англии и Ирландии. Бизнес, налоги, иммиграция, недвижимость, уголовные и семейные споры.">
	<meta property="og:url" content="https://acarkansemenov.com/about">
	...
	<link rel="stylesheet" id="fusion-dynamic-css-css"
		href="wp-content/uploads/fusion-styles/1d51413fd47723c7bf0ac5008bf449d7.min.css" media="all">
					...
					<div class="fusion-page-title-row">
						<div class="fusion-page-title-wrapper">
							<div class="fusion-page-title-captions">
								...
								<h1 class="entry-title">О компании Acarkan & Semenov</h1>
				...
				<div class="fusion-row" style="max-width:100%;">
					<section id="content" class="full-width">
						<div id="post-3492" class="post-3492 page type-page status-publish hentry">
							<span class="entry-title rich-snippet-hidden">О нас</span><span
								class="vcard rich-snippet-hidden"><span class="fn"><a title="Posts by admin"
										rel="author">admin</a></span></span><span
								class="updated rich-snippet-hidden">2025-01-14T16:17:21+00:00</span>
							<div class="post-content">
								<div class="custom-about-us fusion-fullwidth fullwidth-box fusion-builder-row-1 fusion-flex-container nonhundred-percent-fullwidth non-hundred-percent-height-scrolling"
										...
										<div class="fusion-layout-column fusion_builder_column fusion-builder-column-0 fusion_builder_column_1_2 1_2 fusion-flex-column"
											...
											<div
												...
												<div
													...
													<h2 class="fusion-title-heading title-heading-left"
														style="margin:0;">Кратко о нас</h2>
												</div>
												<div class="fusion-text fusion-text-1">
													<p>Наши адвокаты, лицензированные в США, Великобритании, Турции и
														Ирландии, оказывают юридическую поддержку клиентам из СНГ и
														других стран. Мы предлагаем надежные правовые решения,
														способствующие снижению санкционных рисков, укреплению репутации
														и упрощению взаимодействия с международными и федеральными
														структурами США.</p>
												</div>
												<div
													class="fusion-title title fusion-title-2 fusion-sep-none fusion-title-text fusion-title-size-two">
													<h2 class="fusion-title-heading title-heading-left"
														style="margin:0;">Наша практика</h2>
												</div>
												<div class="fusion-text fusion-text-2">
													<p>Корпоративные споры: Разрешение конфликтов между акционерами,
														партнерами и руководством. Защита интересов в судах и
														арбитражах. Юридическое сопровождение сделок и реструктуризаций.

														Налоговые вопросы: Оптимизация налоговой нагрузки. Представление
														интересов в спорах с налоговыми органами. Консультации по
														международному налогообложению.

														Иммиграционное право: Оформление виз, ВНЖ и гражданства.
														Поддержка в вопросах миграционного законодательства.

														Уголовное право: Защита на всех этапах уголовного процесса.
														Представление интересов в сложных делах.

														Семейные споры: Раздел имущества, брачные контракты, алименты,
														опека над детьми. Юридическое сопровождение бракоразводных
														процессов. Недвижимость: Продажи, покупки, дарения, аренды в США
														и любой стране мира</p>
												</div>
												<div
													class="fusion-title title fusion-title-3 fusion-sep-none fusion-title-text fusion-title-size-two">
													<h2 class="fusion-title-heading title-heading-left"
														style="margin:0;">География клиентов</h2>
												</div>
												<div class="fusion-text fusion-text-3"
													style="--awb-content-alignment:left;">
													<p>Мы работаем на территории большинства стран СНГ: Казахстан,
														Армения, Азербайджан, Кыргызстан, Молдова, Таджикистан,
														Узбекистан. Наша экспертиза охватывает весь регион, обеспечивая
														юридическую поддержку бизнесу и частным клиентам. Мы знаем
														юридические и национальные особенности каждой из стран наших
														клиентов и используем это для достижения ваших целей.</p>
												</div>
											...
											<div
												...
												<div class="fusion-image-element "
													...
													<span
														...
														style="border-radius:10px;"><img fetchpriority="high"
															decoding="async" width="2148" height="2560" title="TFG-28"
															src="data:image/svg+xml,%3Csvg xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27 width%3D%272148%27 height%3D%272560%27 viewBox%3D%270 0 2148 2560%27%3E%3Crect width%3D%272148%27 height%3D%272560%27 fill-opacity%3D%220%22%2F%3E%3C%2Fsvg%3E"
															data-orig-src="wp-content/uploads/2022/04/TFG-28-scaled.jpg"
															alt="" class="lazyload img-responsive wp-image-3683"></span>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="member-of">
										<img src="uploads\member-of\3BCA.jpg" alt="3bca">
										<img src="uploads\member-of\ABA.PNG" alt="member-img">
										<img src="uploads\member-of\AILA.jpg" alt="member-img">
										<img src="uploads\member-of\dc-bar.jpg" alt="member-img">
										<img src="uploads\member-of\england-and-wales2.jpg" alt="member-img">
										<img src="uploads\member-of\izmir.PNG" alt="member-img">
										<img src="uploads\member-of\law-soc.PNG" alt="member-img">
										<img src="uploads\member-of\NJ-State-Bar-Association-Logo.png" alt="member-img">
										<img src="uploads\member-of\nysba.png" alt="member-img">
										<img src="uploads\member-of\TBB.jpg" alt="member-img">
									</div>
								</div>
								...
								<div class="fusion-fullwidth fullwidth-box fusion-builder-row-3 fusion-flex-container nonhundred-percent-fullwidth non-hundred-percent-height-scrolling"
									...
									<div class="fusion-builder-row fusion-row fusion-flex-align-items-flex-start fusion-flex-content-wrap"
										style="justify-content: center;max-width:1227.2px;margin-left: calc(-4% / 2 );margin-right: calc(-4% / 2 );">
										<div class="fusion-layout-column fusion_builder_column fusion-builder-column-6 fusion_builder_column_1_6 1_6 fusion-flex-column"
											style="--awb-bg-size:cover;--awb-width-large:16.666666666667%;--awb-margin-top-large:20px;--awb-spacing-right-large:11.52%;--awb-margin-bottom-large:20px;--awb-spacing-left-large:11.52%;--awb-width-medium:16.666666666667%;--awb-order-medium:0;--awb-spacing-right-medium:11.52%;--awb-spacing-left-medium:11.52%;--awb-width-small:100%;--awb-order-small:0;--awb-spacing-right-small:1.92%;--awb-spacing-left-small:1.92%;">
											<div
												class="fusion-column-wrapper fusion-column-has-shadow fusion-flex-justify-content-flex-start fusion-content-layout-column">
											</div>
										</div>
								...
								<div
									...
									<div class="fusion-image-element "
										...
										<span class=" fusion-imageframe imageframe-none imageframe-5 hover-type-none"
											style="border-radius:10px;"><img decoding="async" width="280" height="79"
												title="Acarkan & Semenov"
												src="wp-content/uploads/2021/06/the-firm-lawgroup.png"
												data-orig-src="wp-content/uploads/2021/06/the-firm-lawgroup.png" alt=""
												class="lazyload img-responsive wp-image-3442"
									...
									<div class="fusion-text fusion-text-4" style="--awb-text-color:#ffffff;">
										<p>Защита бизнеса и прав в США и других странах мира — услуги адвокатов по всем
											направлениям права.
											Наша команда юристов, имеющих адвокатские лицензии США, Великобритании,
											Турции и Ирландии, поможет вам в вопросах бизнеса, налогов, недвижимости,
											уголовного и семейного права, а также в иммиграционных делах. Мы предлагаем
											надежную правовую защиту и полное юридическое сопровождение в США и за их
											пределами. Благодаря нашему международному опыту и многопрофильной
											экспертизе, мы гарантируем высокое качество услуг и эффективное решение
											ваших задач, независимо от сложности или юрисдикции.</p>
									</div>
