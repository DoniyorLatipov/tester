...
<head>
    ...
    <meta name="description" content="<?php echo $post_info['description'] ?>">
    <!-- Ключевые слова -->
    <meta name="keywords" content="<?php echo $post_info['keywords'] ?>">

    <!-- Canonical URL -->
    <link rel="canonical" href="<?php echo $post_info['canonical'] ?>">
    <meta property="og:locale" content="ru">
    <meta property="og:type" content="article">
    <meta property="og:title" content="<?php echo $post_info['title'] ?>">
    <meta property="og:description" content="<?php echo $post_info['description'] ?>">
    <meta property="og:url" content="<?php echo $post_info['canonical'] ?>">
    <meta property="article:modified_time" content="2025-01-29T16:11:26+00:00">
...
<body
                    ...
                    <div class="fusion-page-title-row">
                        <div class="fusion-page-title-wrapper">
                            <div class="fusion-page-title-captions">
                                ...
                                <h2 class="entry-title"><?php echo $post_info['name'] ?></h2>
                ...
                <div class="fusion-row" style="max-width:100%;">
                    <section id="content" class="full-width">
                        <div id="post-3951" class="post-3951 page type-page status-publish hentry">
                            <span class="entry-title rich-snippet-hidden"><?php echo $post['name'] ?></span><span
                                class="vcard rich-snippet-hidden"><span class="fn"><a title="Posts by admin"
                                        rel="author">admin</a></span></span><span
                                class="updated rich-snippet-hidden">2025-01-29T16:11:26+00:00</span>
                            <div class="post-content">
                                <div class="post-container" style="    max-width: 1227.2px;
    margin:0 auto; padding: 0 calc(4% / 2);">
                                    <!-- Контент поста -->
                                ...
                                <div class="fusion-fullwidth fullwidth-box fusion-builder-row-2 fusion-flex-container nonhundred-percent-fullwidth non-hundred-percent-height-scrolling"
                                    style="--awb-border-radius-top-left:0px;--awb-border-radius-top-right:0px;--awb-border-radius-bottom-right:0px;--awb-border-radius-bottom-left:0px;--awb-padding-top:40px;--awb-padding-bottom:40px;--awb-background-color:#15487b;--awb-flex-wrap:wrap;">
                                            ...
                                            <div
                                                ...
                                                <div class="fusion-title title fusion-title-2 fusion-sep-none fusion-title-center fusion-title-text fusion-title-size-one"
                                                    ...
                                                    <h2 class="fusion-title-heading title-heading-center"
                                                        style="margin:0;">Почему выбирают нас?</h2>
                                                </div>
                                                <div class="fusion-text fusion-text-7"
                                                    style="--awb-text-color:#ffffff;">
                                                    <p><strong>Защита от санкций и рейдерских атак</strong> – Мы
                                                        помогаем не допустить международных санкций, недружественных
                                                        поглощений, давления со стороны конкурентов и чиновников.<br>
                                                        <strong>Глубокое понимание стран СНГ</strong> – Мы
                                                        специализируемся на правовых вопросах стран СНГ, знаем их
                                                        законодательные особенности, национальные традиции и внутренние
                                                        механизмы.<br>
                                                        <strong>Комплексная юридическая защита</strong> – Проводим аудит
                                                        бизнеса, минимизируем налоговые риски, защищаем активы и
                                                        устраняем юридические ошибки.<br>
                                                        <strong>Юридическая поддержка международного уровня</strong> –
                                                        Наши адвокаты специализируются на международном праве, налоговом
                                                        планировании, корпоративных спорах и защите активов. Мы работаем
                                                        с крупными компаниями, стартапами и частными клиентами.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="fusion-layout-column fusion_builder_column fusion-builder-column-3 fusion_builder_column_1_2 1_2 fusion-flex-column"
                                            ...
                                            <div
                                                ...
                                                <div class="fusion-form fusion-form-builder fusion-form-form-wrapper fusion-form-3549"
                                                    ...
                                                    data-form-id="3549"
                                                    data-config="{&quot;form_id&quot;:&quot;3549&quot;,&quot;form_post_id&quot;:&quot;3549&quot;,&quot;post_id&quot;:3951,&quot;form_type&quot;:&quot;ajax&quot;,&quot;confirmation_type&quot;:&quot;message&quot;,&quot;redirect_url&quot;:&quot;&quot;,&quot;field_labels&quot;:{&quot;full_name&quot;:&quot;&quot;,&quot;email&quot;:&quot;&quot;,&quot;phone&quot;:&quot;&quot;,&quot;case-details&quot;:&quot;&quot;},&quot;field_logics&quot;:{&quot;full_name&quot;:&quot;&quot;,&quot;email&quot;:&quot;&quot;,&quot;phone&quot;:&quot;&quot;,&quot;case-details&quot;:&quot;&quot;,&quot;notice_1&quot;:&quot;&quot;},&quot;field_types&quot;:{&quot;full_name&quot;:&quot;text&quot;,&quot;email&quot;:&quot;email&quot;,&quot;phone&quot;:&quot;phone_number&quot;,&quot;case-details&quot;:&quot;textarea&quot;,&quot;notice_1&quot;:&quot;notice&quot;,&quot;submit_1&quot;:&quot;submit&quot;},&quot;nonce_method&quot;:&quot;ajax&quot;}">
                                                    <form class="fusion-form fusion-form-3549">
                                                        <div class="fusion-fullwidth fullwidth-box fusion-builder-row-3-1 fusion-flex-container nonhundred-percent-fullwidth non-hundred-percent-height-scrolling"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="fusion-title title fusion-title-4 fusion-sep-none fusion-title-center fusion-title-text fusion-title-size-three"
                                                                            ...
                                                                            <h3 class="fusion-title-heading title-heading-center"
                                                                                style="margin:0;">Опишите свою проблему
                                                                            </h3>
                                                                        </div>
                                                                        <div class="fusion-title title fusion-title-5 fusion-sep-none fusion-title-center fusion-title-text fusion-title-size-four"
                                                                            ...
                                                                            <h4 class="fusion-title-heading title-heading-center"
                                                                                style="margin:0;">Заполните все поля
                                                                            </h4>
                                                                        </div>
                                                                            ...
                                                                            <div class="fusion-alert alert error alert-danger fusion-alert-center fusion-form-response fusion-form-response-error awb-alert-native-link-color alert-dismissable awb-alert-close-boxed alert-shadow"
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <span class="alert-icon"><i
                                                                                        ...
                                                                                        was an error trying to send your
                                                                        ...
                                                                        <div class="fusion-form-field fusion-form-submit-field fusion-form-label-above"
                                                                            ...
                                                                            <div style="text-align:center;"><button
                                                                                    ...
                                                                                    tabindex=""><span
                                                                                        class="fusion-button-text">Submit
                                                                                        Now</span></button></div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                        ...
                        <div class="fusion-builder-row fusion-row fusion-flex-align-items-flex-start fusion-flex-content-wrap"
                            ...
                            <div class="fusion-layout-column fusion_builder_column fusion-builder-column-5 fusion_builder_column_1_2 1_2 fusion-flex-column"
                                ...
                                <div
                                    ...
                                    <div class="fusion-text fusion-text-9" style="--awb-text-color:#ffffff;">
                                        <p>Юридические услуги в США: адвокаты по бизнесу, иммиграции, налогам,
                                            недвижимости и семейному праву.
                                            Мы специализируемся на недвижимости, бизнес-праве, семейном праве, уголовном
                                            праве, налоговом праве и иммиграции в США. Наши юристы, обладающие
                                            адвокатскими лицензиями США, Великобритании, Турции и Ирландии, готовы
                                            предоставить вам профессиональную правовую поддержку, защиту в суде и
                                            консультации по любым вопросам. Благодаря нашему международному опыту и
                                            многопрофильной экспертизе, мы обеспечиваем высокое качество услуг и
                                            эффективное решение ваших юридических задач, независимо от сложности или
                                            юрисдикции.</p>
                                    </div>
    ...
    <div id="copyrightscp"
        style="display:none!important;color:#FFFFFF!important;background-color:#FFFFFF!important;opacity:0!important;font-family:Arial,Tahoma,Geneva,Helvetica,sans-serif!important;font-size:1px!important;">
        <p
            style="display:none!important;color:#FFFFFF!important;background-color:#FFFFFF!important;opacity:0!important;font-family:Arial,Tahoma,Geneva,Helvetica,sans-serif!important;font-size:1px!important;">
            SiteCopy.Pro - это <a
                style="display:none!important;color:#FFFFFF!important;background-color:#FFFFFF!important;opacity:0!important;font-family:Arial,Tahoma,Geneva,Helvetica,sans-serif!important;font-size:1px!important;"
                href="https://sitecopy.pro/"
                title="Копирование сайтов, шаблоны landing page, создание копии, клона лендинга - Онлайн-сервис">сервис
                по копированию сайтов онлайн и шаблоны лендингов</a>. Здесь можно полностью скопировать лендинг, скачать
            шаблон landing page, сделать парсинг, рип, клон, точную копию одностраничника и переделать его под себя.
            Сервис позволяет целиком клонировать и парсить защищенные протоколом https сайты.</p>
    </div>
    <!-- Google tag (gtag.js) -->
